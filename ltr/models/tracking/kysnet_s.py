...
import ltr.models.kys_s.predictor_wrapper as predictor_wrappers
import ltr.models.kys_s.response_predictor as resp_pred
import ltr.models.kys_s.cost_volume as cost_volume


class KYSnet_s(nn.Module):
    """The DiMP network.
    args:
    ...
    def __init__(self, feature_extractor, classifier, bb_regressor, predictor, classification_layer, bb_regressor_layer):
        super().__init__()
    ...
    def get_motion_feat(self, backbone_feat):
        ...
        return self.predictor.extract_motion_feat(backbone_feat[self.classification_layer[0]])
...
@model_constructor
def kysnet_s(filter_size=1, optim_iter=5, optim_init_step=1.0, optim_init_reg=0.01,
    ...
    cost_volume_layer = cost_volume.CostVolume(3, 9, stride=1,
    ...
    # DiMP network
    net = KYSnet_s(feature_extractor=backbone_net, classifier=classifier, bb_regressor=bb_regressor,
                  predictor=response_predictor,
                  classification_layer=classification_layer, bb_regressor_layer=['layer2', 'layer3'])
    return net

@model_constructor
def kysnet_s50(filter_size=1, optim_iter=5, optim_init_step=1.0, optim_init_reg=0.01,
