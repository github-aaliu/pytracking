...
import ltr.models.bh.kalman_filter as Kalman
import ltr.models.bh.cost_volume as cost_volume
import ltr.models.bh.comove_predictor as comove_predictor
...
class BHNet(nn.Module):
    ...
    def __init__(self, backbone_feature_extractor, dimp_classifier,corre_move_model,
        ...
        self.feature_extractor = backbone_feature_extractor
        self.classifier = dimp_classifier
        self.corre_move_model = corre_move_model
    ...
    def train_classifier(self, train_imgs, train_bb):
        ...
        filter, train_losses = self.classifier.train_classifier(train_feat_clf, train_bb)
        return filter
...
@model_constructor
def BHnet_res50(filter_size=4, optim_iter=3, appearance_feature_dim=512,
                 ...
                 bin_displacement=0.1, detach_length=float('Inf'),train_feature_extractor=False, train_iounet=True,
                 iou_input_dim=(256, 256), iou_inter_dim=(256, 256),
                 cv_kernel_size=5, cv_max_displacement=9, cv_stride=1,
                 init_gauss_sigma=1.0,out_feature_dim=0,
    ...
    corre_move_model = comove_predictor.comove_predictor(cost_volume=cost_volume_layer, kalmanFilter=kalman)

    net = BHNet(backbone_feature_extractor=backbone_net, dimp_classifier=classifier,
                corre_move_model = corre_move_model,
