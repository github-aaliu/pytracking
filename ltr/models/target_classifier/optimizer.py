...
import ltr.models.siamD.deformconv2d as def_conv2



class siamDSteepestDescentGN(nn.Module):
    ...
    def forward(self, weights, feat, bb, sample_weight=None, num_iter=None, compute_losses=True):
        ...
        offset = (bb[..., 2:]/self.feat_stride).flip(2)
        ...
        for i in range(num_iter):
            ...
            # Compute residuals
            scores= self.D_conv2(feat, weights, offset).sum(2)
